...
This **Acceptable Usage Policy** (**AUP**) applies to the official instance of Artismaga available at [artismaga.com](http://artismaga.com). Self-hosted instances may choose to adopt this AUP if they wish. 
...
- Sharing any kind of copyrighted content, or any type of content that violates another person's personal, intellectual property or other rights. This includes any content that would violate the Digital Millennium Copyright Act (DMCA). We respond to DMCA requests as described in our [Terms of Service](https://artismaga.com/terms).
- Using Artismaga for illegal operations. These include, but are not limited to, hacking, the cracking or distribution of pirated software, cheats, exploits or hacks for our or another company or person's service.
- Using Artismaga with malicious intent, in a way that is not reasonable under normal usage, in order to outsource computing and/or storage resources to our servers, as well as other forms of Denial of Service to our infrastructure.
...
- The selling and buying of Artismaga accounts is prohibited.

To report any of the above activity, contact us at [abuse@artismaga.com](mailto:abuse@artismaga.com).
...
If you would like to appeal a suspension, please contact [abuse@artismaga.com](mailto:abuse@artismaga.com).
